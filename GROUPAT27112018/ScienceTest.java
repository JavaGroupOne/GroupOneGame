...
public class ScienceTest extends JFrame 
{
	...
	//public double itscore,mscore,sciquizscorecal;
	...
	//constructor
	public ScienceTest(String user) 
	{
		username=user;
	...
	public void initializeComponents(String username)
	{
		...
		rdbtnA.setBackground(Color.PINK);
		...
		rdbtnB.setBackground(Color.PINK);
		...
		rdbtnD.setBackground(Color.PINK);
		...
		SciQuestion.setBackground(Color.PINK);
	...
	public ArrayList<String[]> getQuestions() 
	{
		...
		allQues = "SELECT * from ScienceQuestions";
...
return questions;
	...
	{
		double sciquizscore,sciquizscorecal,sciquizscorepercent;
		String sql,sql2;
		PreparedStatement Prepstat,Prepstat2;
		 
		sciquizscore = Double.valueOf(correctAnsCount);
		sciquizscorecal = (sciquizscore/15.0)*100;
		sciquizscorepercent = (Math.round(((sciquizscorecal)*100.0))/100.0);
		JOptionPane.showMessageDialog(null, "Your Quiz is finished. Your score is "+sciquizscorepercent+"%");
		
		try 
		{
			sql = "update Userinfo set sciscore='"+sciquizscorepercent+"' where usernam='"+username+"'";
