...
public class MathTest extends JFrame 
{
	...
	//public double itscore,sciscore,mathquizscorecal;
	...
	public void initializeComponents(String username)
	{
		...
		rdbtnA.setBackground(new Color(51, 0, 0));
		...
		rdbtnB.setBackground(new Color(51, 0, 0));
		...
		rdbtnC.setBackground(new Color(51, 0, 0));
		...
		rdbtnD.setBackground(new Color(51, 0, 0));
		rdbtnD.setBounds(162, 360, 46, 23);
		contentPane.add(rdbtnD);
		
		itQuestion = new JTextArea();
		itQuestion.setForeground(Color.WHITE);
		itQuestion.setFont(new Font("Gill Sans MT", Font.BOLD, 15));
		itQuestion.setEditable(false);
		itQuestion.setBackground(new Color(51, 0, 0));
		itQuestion.setText(questions.get(index)[0]);
		itQuestion.setLineWrap(true);
		itQuestion.setWrapStyleWord(true);
		itQuestion.setBounds(152, 146, 447, 98);
	...
	public ArrayList<String[]> getQuestions() 
	{
		...
		allQues = "SELECT * from MathQuestions";
...
return questions;
	...
	{
		double mathquizscore,mathquizscorecal,mathquizscorepercent;
		String sql,sql2;
		PreparedStatement Prepstat,Prepstat2;
		 
		mathquizscore = Double.valueOf(correctAnsCount);
		mathquizscorecal = (mathquizscore/15.0)*100;
		mathquizscorepercent = (Math.round(((mathquizscorecal)*100.0))/100.0);
		JOptionPane.showMessageDialog(null, "Your Quiz is finished. Your score is "+mathquizscorepercent+"%");
		
		try 
		{
			sql = "update Userinfo set mscore='"+mathquizscorepercent+"' where usernam='"+username+"'";
